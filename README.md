This is an example [Next.js](https://nextjs.org/) project to show how routing works in a Next.js application. There is basically no data source, all data is consumed from a dummy backend service.
